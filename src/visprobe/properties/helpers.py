...
def get_topk_predictions(output: torch.Tensor, k: int) -> Tuple[List[int], List[float]]:
    """
    Gets the top-k prediction indices and confidences.
    ...
    Returns:
        A tuple containing (list_of_top_k_indices, list_of_top_k_confidences).
