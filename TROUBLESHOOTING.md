...
**Symptoms:**
```
DeprecationWarning: The decorator-based API is deprecated
```

**Solution:**

Update your code to use the new `quick_check()` API:
...
@model(my_model)
@data_source(my_data)
def test_func(original, perturbed):
    ...
```
...
report = quick_check(my_model, my_data, preset="standard")
```
