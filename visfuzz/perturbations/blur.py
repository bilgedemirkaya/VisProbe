...
class GaussianBlur(BatchedPerturbation):
    """
    ...
    Example:
        ...
        >>> perturbed = blur(images, level=2.0)  # sigma=2.0
    """
    ...
    def apply(
        ...
        **kwargs: Any,
        ...
        kernel = self._get_kernel(level, images.device)
...
class MotionBlur(BatchedPerturbation):
    """
    ...
    def apply(
        ...
        **kwargs: Any,
        ...
        kernel = self._get_kernel(kernel_size, self.angle, images.device)
...
class DefocusBlur(BatchedPerturbation):
    """
    ...
    def apply(
        ...
        **kwargs: Any,
        ...
        kernel = self._get_kernel(radius, images.device)
        k_size = kernel.shape[0]
        padding = k_size // 2
...
class BoxBlur(BatchedPerturbation):
    """
    ...
    def apply(
        ...
        **kwargs: Any,
        ...
        kernel = self._get_kernel(kernel_size, images.device)
        padding = kernel_size // 2
